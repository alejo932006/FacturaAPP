...
public class ClientesGUI extends JDialog { // Cambiado de JFrame a JDialog para mejor comportamiento
    ...
    private void initComponents() {
        ...
        // Tabla de Clientes
        String[] columnas = {"Nombre", "Cédula", "Dirección"};
    ...
    private void cargarClientesEnTabla() {
        ...
        ClienteStorage.cargarClientes().forEach(c -> {
            modelo.addRow(new Object[]{c.getNombre(), c.getCedula(), c.getDireccion()});
        });
    }
    ...
    private void cargarClienteSeleccionado() {
        ...
        if (filaVista >= 0) {
            ...
            // --- CAMBIO CLAVE: Llamamos al método de la interfaz ---
            if (listener != null) {
                listener.setDatosCliente(nombre, cedula, direccion);
            }
            dispose(); // Cierra la ventana de clientes
        } else {
